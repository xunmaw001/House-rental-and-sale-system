          ...
          <el-form-item class="input" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="房型" prop="fangxing">
          <el-select v-model="ruleForm.fangxing" placeholder="请选择房型">
            <el-option
                v-for="(item,index) in fangxingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出租定金" prop="chuzudingjin">
          <el-input v-model="ruleForm.chuzudingjin" 
              placeholder="出租定金" clearable  :readonly="ro.chuzudingjin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出租定金" prop="chuzudingjin">
              <el-input v-model="ruleForm.chuzudingjin" 
                placeholder="出租定金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="出售价格" prop="chushoujiage">
              <el-input v-model="ruleForm.chushoujiage" 
                placeholder="出售价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出售定金" prop="chushoudingjin">
          <el-input v-model="ruleForm.chushoudingjin" 
              placeholder="出售定金" clearable  :readonly="ro.chushoudingjin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出售定金" prop="chushoudingjin">
              <el-input v-model="ruleForm.chushoudingjin" 
                placeholder="出售定金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                                                    </el-row>
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房屋设施" prop="fangwusheshi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fangwusheshi" label="房屋设施" prop="fangwusheshi">
                    <span>{{ruleForm.fangwusheshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dizhi = true;
            continue;
	            	            ...
	            	            if(o=='chuzudingjin'){
            this.ruleForm.chuzudingjin = obj[o];
	    this.ro.chuzudingjin = true;
            continue;
          }
	            	            if(o=='chuzujiage'){
	    ...
	    this.ro.chushoujiage = true;
            continue;
	            	            ...
	            	            if(o=='chushoudingjin'){
            this.ruleForm.chushoudingjin = obj[o];
	    this.ro.chushoudingjin = true;
            continue;
          }
	            	            if(o=='fangwusheshi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fangwuzushou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fangwuzushouCrossAddOrUpdateFlag = false;
                  this.parent.search();
