  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="租售类型" prop="zushouleixing">
          <el-select v-model="ruleForm.zushouleixing" placeholder="请选择租售类型">
            <el-option
                v-for="(item,index) in zushouleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="租售类型" prop="zushouleixing">
	      <el-input v-model="ruleForm.zushouleixing"
                placeholder="租售类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="合同名称" prop="hetongmingcheng">
          <el-input v-model="ruleForm.hetongmingcheng" 
              placeholder="合同名称" clearable  :readonly="ro.hetongmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="合同名称" prop="hetongmingcheng">
              <el-input v-model="ruleForm.hetongmingcheng" 
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
            continue;
	            	            ...
	            	            if(o=='zushouleixing'){
            this.ruleForm.zushouleixing = obj[o];
	    this.ro.zushouleixing = true;
            continue;
          }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zushouhetong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zushouhetongCrossAddOrUpdateFlag = false;
                  this.parent.search();
